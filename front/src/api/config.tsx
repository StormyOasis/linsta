...
export const LAMBDA_HOST = isBrowser ? window.env.REACT_APP_LAMBDA_HOST : (process?.env?.REACT_APP_LAMBDA_HOST || "http://localhost:3003");
export const VISITOR_LAMBDA_HOST = isBrowser ? window.env.REACT_APP_VISITOR_LAMBDA_HOST : (process?.env?.REACT_APP_VISITOR_LAMBDA_HOST || "http://localhost:3003");
...
export const DEFAULT_PFP = `${HOST}/public/images/pfp-default.svg`;
