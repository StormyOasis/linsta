...
export class MySqlDBConnector {
    private static instance:MySqlDBConnector | null = null;
    ...
    public static getInstance() : MySqlDBConnector {
...
export default MySqlDBConnector.getInstance();